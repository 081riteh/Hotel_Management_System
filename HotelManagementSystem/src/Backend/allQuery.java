...
public class allQuery {
    ...
    public static ResultSet checkRoomAvailability(Connection con,int room_size,String room_type) throws SQLException {
    ...
    public static Map<String, Float> getMenu(Connection con) throws SQLException {
...
//    }
	...
	public static void addCustomerData(Connection con,String name, String password, String gender,int age, String aadharNo, String phoneNo,
			int i,int roomId) throws SQLException {
		// TODO Auto-generated method stub
		
		String query="insert into hotel_customer(passwd,user_name,age,aadhar_no,phone_no,gender,amount,room_id) values(?,?,?,?,?,?,?,?)";
		PreparedStatement psmt=con.prepareStatement(query);
		psmt.setString(1, password);
	...
	public static void changeAvailabilityData(Connection con,int roomId,int i) throws SQLException {
		// TODO Auto-generated method stub
	...
	public static ResultSet fetchCustomerData(Connection con, int roomNo) throws SQLException {
		// TODO Auto-generated method stub
		String query="select * from hotel_customer where room_id=?";
		PreparedStatement psmt=con.prepareStatement(query);
	...
	public static void deleteCustomerData(Connection con, int roomNo) throws SQLException {
		// TODO Auto-generated method stub
	...
	public static void changePassData(Connection con, int roomNo, String pass) throws SQLException {
		// TODO Auto-generated method stub
	...
	public static void updateCustomerAmountData(Connection con, int roomNo, float amount) throws SQLException {
		// TODO Auto-generated method stub
