...
public class Receptionist {
	...
	static int bookRoom(int roomId) throws SQLException, ParseException {		
		...
		allQuery.addCustomerData(DBHome.getCon(),name,password,gender,age,aadharNo,phoneNo,0,roomId,checkInDate);
		return 0;
	}
...
//			String checkInDate=to_Stringdata.getDate("check_in_date");
			...
			ResultSet d=allQuery.roomPriceData(DBHome.getCon(),roomNo);
			while(d.next()) {
